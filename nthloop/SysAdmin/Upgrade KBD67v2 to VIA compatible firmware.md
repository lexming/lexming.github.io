...
tags:
  ...
  - firmware
---
Keyboards with a [VIA](https://caniusevia.com/) compatible firmware can have their layouts easily configured with the [VIA Configurator](https://github.com/the-via/releases/releases). A user-space application that can be run without any special permissions and that supports Linux! :tada:
...
Even though the factory firmware in my [KBDfans KBD67v2](https://kbdfans.com/) is not VIA compatible, it is actually supported by VIA and they provide a new firmware for this keyboard. So, let's upgrade it:
...
3. Download and install  [VIA Configurator](https://github.com/the-via/releases/releases) in your computer as usual
